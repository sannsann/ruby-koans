...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # #inject iterates through the elements in the array, performing the block operation
    # then storing the result of the block in a variable which will be used for the next 
  ...
  #
  # The block keeps the code involving the file enclosed in a organized fashion.
  # Does it close it at the end too?
